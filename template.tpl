...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Mailchimp Event Track",
  "brand": {
    "id": "brand_dummy",
    "displayName": "Stape",
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "help": "More info about tags can be found \u003ca href\u003d\"https://mailchimp.com/developer/marketing/api/list-member-tags/\" target\u003d\"_blank\"\u003ehere\u003c/a\u003e.",
        "displayName": "Tags"
      }
    ],
    "enablingConditions": [
